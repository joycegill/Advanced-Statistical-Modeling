...
class_size_clean <- class_size_clean %>%
  mutate(
    ...
    CLASIZUND20 = as.numeric(str_remove(CLASIZUND20, "%")),
    CLASIZ2049 = as.numeric(str_remove(CLASIZ2049, "%")),
    CLASIZOVE50 = as.numeric(str_remove(CLASIZOVE50, "%"))
  )
...
final_data <- class_size_clean %>%
  ...
  select(UNITID, INSTNM, STUFACR, CLASIZUND20, CLASIZ2049, CLASIZOVE50) %>%
